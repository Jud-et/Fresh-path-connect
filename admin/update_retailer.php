					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update retailer set c_id='$_POST[c_name]', title='$res_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',address='$_POST[address]',image='$fnew' where rs_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql); 
													mysqli_query($db, $sql); 
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-archive f-s-20 color-warning"></i><span class="hide-menu">Retailer</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_retailer.php">All Retailers</a></li>
								<li><a href="add_category.php">Add Category</a></li>
                                <li><a href="add_retailer.php">Add Retailer</a></li>
                                
                            </ul>
                        </li>
                      <li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-cutlery" aria-hidden="true"></i><span class="hide-menu">Produce</span></a>
                            <ul aria-expanded="false" class="collapse">
								<li><a href="all_produce.php">All Produce</a></li>
								<li><a href="add_produce.php">Add Produce</a></li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0 ">Update Retailer</h4>
                            
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from retailer where rs_id='$_GET[res_upd]'";
											...
											<div class="col-md-6">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
                                                 ...
                                                 <?php $ssql ="select * from ret_category";
													$res=mysqli_query($db, $ssql); 
                                        ...
                                        <h3 class="box-title m-t-40">Retailer Address</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a href="all_retailer.php" class="btn btn-inverse">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
